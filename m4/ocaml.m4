...
dnl
dnl PTFS NOTE: The file is from ocaml-autoconf project 
dnl	       (http://forge.ocamlcore.org/projects/ocaml-autoconf/).
dnl	       For the license terms see the file m4/ocaml-autoconf-license.
