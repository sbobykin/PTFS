...
static const yytype_uint8 yyprhs[] =
{
      ...
      24,    25,    28,    29,    34,    38,    40,    42,    45,    48
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    16,    18,    17,    -1,    16,    20,    -1,
      18,    17,    -1,    20,    -1,    -1,     8,    -1,    18,     3,
      19,    -1,     7,    -1,    -1,     9,     6,    -1,    -1,     4,
      21,    22,    17,    -1,    22,    10,    23,    -1,    23,    -1,
      24,    -1,    24,     3,    -1,    24,     5,    -1,    -1
};
...
{
  "$end", "error", "$undefined", "IDENT", "SEM_IDENT", "CHAR", "NUMBER",
  "TERM", "';'", "'='", "'|'", "'#'", "'-'", "'('", "')'", "$accept",
  "file", "opt_sem", "terms", "number", "rule", "@1", "rhs", "alt", "seq", 0
};
#endif
...
{
       7,    10,    17,    16,     1,    23,    11,     2,    20,     1,
       8,    11,     2,    19,    21,     9,    22,     0,     0,     0,
      24
};

static const yytype_int8 yycheck[] =
{
       0,     3,     9,     8,     4,     6,     8,     7,    13,     4,
       3,     8,     7,    10,     3,     3,     5,    -1,    -1,    -1,
      19
};
...
#line 162 "sgramm.y"
    {
	  ...
	  term.repr = (char *) (yyvsp[(2) - (3)].ref);
	  term.code = (yyvsp[(3) - (3)].num);
